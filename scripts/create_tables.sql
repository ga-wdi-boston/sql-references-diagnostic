...
CREATE TABLE appointments(id SERIAL PRIMARY KEY, date TEXT, time TEXT, comments TEXT, doctor_id INTEGER REFERENCES doctors(id), patient_id INTEGER REFERENCES patients(id));
